...
cd /data/projects/kaiwu-fwk/framework/server/cpp/src/actor/trt_inference
...
export PYTHONPATH=$PYTHONPATH:/data/projects/kaiwu-fwk/framework/server/cpp/src/actor/trt_inference/src_kaiwudrl/
