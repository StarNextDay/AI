    ...
    def _inference(self, seri_vec, init_lstm_cell, init_lstm_hidden, only_inference=False):
        ...
        with tf.variable_scope("hero_main"):
            ...
            for index in range(len(hero_main)):
                ...
                fc1_hero_weight = self._fc_weight_variable(shape=[vec_fc1_input_dim, ], name="fc1_hero_main_weight")
        ...
        with tf.variable_scope("hero_share", reuse=tf.AUTO_REUSE):
            ...
            for index in range(len(hero_emy)):
                ...
                fc1_hero_weight = self._fc_weight_variable(shape=[vec_fc1_input_dim, 1024], name="fc1_hero_weight")
                fc1_hero_bias = self._bias_variable(shape=[1024], name="fc1_hero_bias")
                fc1_hero_result = tf.nn.relu((tf.matmul(hero_emy[index], fc1_hero_weight) + fc1_hero_bias),
                                             name="fc1_hero_emy_result_%d" % index)

                fc2_hero_weight = self._fc_weight_variable(shape=[1024, 1024], name="fc2_hero_weight")
                fc2_hero_bias = self._bias_variable(shape=[1024], name="fc2_hero_bias")
                fc2_hero_result = tf.nn.relu((tf.matmul(fc1_hero_result, fc2_hero_weight) + fc2_hero_bias),
                                             name="fc2_hero_emy_result_%d" % index)
                
                fc3_hero_weight = self._fc_weight_variable(shape=[1024, 512], name="fc3_hero_weight")
                fc3_hero_bias = self._bias_variable(shape=[512], name="fc3_hero_bias")
                fc3_hero_result = tf.nn.relu((tf.matmul(fc2_hero_result, fc3_hero_weight) + fc3_hero_bias),
                                             name="fc3_hero_emy_result_%d" % index)
                
                fc4_hero_weight = self._fc_weight_variable(shape=[512, 512], name="fc4_hero_weight")
                fc4_hero_bias = self._bias_variable(shape=[512], name="fc4_hero_bias")
                fc4_hero_result = tf.nn.relu((tf.matmul(fc3_hero_result, fc4_hero_weight) + fc4_hero_bias),
                                             name="fc4_hero_emy_result_%d" % index)
                
                fc5_hero_weight = self._fc_weight_variable(shape=[512, 256], name="fc5_hero_weight")
                fc5_hero_bias = self._bias_variable(shape=[256], name="fc5_hero_bias")
                fc5_hero_result = tf.nn.relu((tf.matmul(fc4_hero_result, fc5_hero_weight) + fc5_hero_bias),
                                             name="fc5_hero_emy_result_%d" % index)
                
                fc6_hero_weight = self._fc_weight_variable(shape=[256, 256], name="fc6_hero_weight")
                fc6_hero_bias = self._bias_variable(shape=[256], name="fc6_hero_bias")
                fc6_hero_result = tf.nn.relu((tf.matmul(fc5_hero_result, fc6_hero_weight) + fc6_hero_bias),
                                             name="fc6_hero_emy_result_%d" % index)
                
                fc7_hero_weight = self._fc_weight_variable(shape=[256, 128], name="fc7_hero_weight")
                fc7_hero_bias = self._bias_variable(shape=[128], name="fc7_hero_bias")
                fc7_hero_result = tf.nn.relu((tf.matmul(fc6_hero_result, fc7_hero_weight) + fc7_hero_bias),
                                             name="fc7_hero_emy_result_%d" % index)

                fc8_hero_weight = self._fc_weight_variable(shape=[128, 128], name="fc8_hero_emy_weight")
                fc8_hero_bias = self._bias_variable(shape=[128], name="fc8_hero_emy_bias")
                fc8_hero_result = tf.add(tf.matmul(fc7_hero_result, fc8_hero_weight), fc8_hero_bias,
                                         name="fc8_hero_emy_result_%d" % index)
                ## emy_hero_embedding
                split_0, split_1 = tf.split(fc8_hero_result, [96, 32], axis=1)
                tar_embed_list.append(split_1)

                hero_emy_result_list.append(fc8_hero_result)
            ...
            for index in range(len(hero_frd)):
                ...
                fc8_hero_weight = self._fc_weight_variable(shape=[128, 128], name="fc8_hero_frd_weight")
                fc8_hero_bias = self._bias_variable(shape=[128], name="fc8_hero_frd_bias")
                fc8_hero_result = tf.add(tf.matmul(fc7_hero_result, fc8_hero_weight), fc8_hero_bias,
                ...
                hero_frd_result_list.append(fc8_hero_result)
        ...
        with tf.variable_scope("soldier_share", reuse=tf.AUTO_REUSE):
            ...
            for index in range(len(soldier_1_10)):
                ...
                fc1_soldier_weight = self._fc_weight_variable(shape=[vec_fc1_input_dim, 1024], name="fc1_soldier_weight")
                fc1_soldier_bias = self._bias_variable(shape=[1024], name="fc1_soldier_bias")
                ...
                fc2_soldier_weight = self._fc_weight_variable(shape=[1024, 512], name="fc2_soldier_weight")
                fc2_soldier_bias = self._bias_variable(shape=[512], name="fc2_soldier_bias")
                ...
                fc3_soldier_weight = self._fc_weight_variable(shape=[512, 256], name="fc3_soldier_weight")
                fc3_soldier_bias = self._bias_variable(shape=[256], name="fc3_soldier_bias")
                ...
                fc4_soldier_weight = self._fc_weight_variable(shape=[256, 128], name="fc4_soldier_weight")
                ...
                fc5_soldier_weight = self._fc_weight_variable(shape=[128, 64], name="fc5_soldier_weight")
                fc5_soldier_bias = self._bias_variable(shape=[64], name="fc5_soldier_bias")
                ...
                fc6_soldier_weight = self._fc_weight_variable(shape=[64, 64], name="fc6_soldier_weight")
                fc6_soldier_bias = self._bias_variable(shape=[64], name="fc6_soldier_bias")
                ...
                fc7_soldier_weight = self._fc_weight_variable(shape=[64, 32], name="fc7_soldier_1_weight")
                fc7_soldier_bias = self._bias_variable(shape=[32], name="fc7_soldier_1_bias")
                fc7_soldier_result = tf.add(tf.matmul(fc6_soldier_result, fc7_soldier_weight), fc7_soldier_bias,
                                            name="fc7_soldier_1_result_%d" % index)

                soldier_1_result_list.append(fc7_soldier_result)
        ...
        # with tf.variable_scope("soldier_31_60"):
            ...
            for index in range(len(soldier_11_20)):
                ...
                fc7_soldier_weight = self._fc_weight_variable(shape=[64, 32], name="fc7_soldier_2_weight")
                fc7_soldier_bias = self._bias_variable(shape=[32], name="fc7_soldier_2_bias")
                fc7_soldier_result = tf.add(tf.matmul(fc6_soldier_result, fc7_soldier_weight), fc7_soldier_bias,
                                            name="fc7_soldier_2_result_%d" % index)
                ## emy soldier embedding
                # split_0, split_1 = tf.split(fc3_soldier_result, [16,16], axis=1)
                tar_embed_list.append(fc7_soldier_result)

                soldier_2_result_list.append(fc7_soldier_result)
        ...
        with tf.variable_scope("organ_share", reuse=tf.AUTO_REUSE):
            ...
            for index in range(len(organ_1_2)):
                ...
                fc2_organ_weight = self._fc_weight_variable(shape=[1024, 512], name="fc2_organ_weight")
                fc2_organ_bias = self._bias_variable(shape=[512], name="fc2_organ_bias")
                fc2_organ_result = tf.nn.relu((tf.matmul(fc1_organ_result, fc2_organ_weight) + fc2_organ_bias),
                                              name="fc2_organ_1_result_%d" % index)
                
                fc3_organ_weight = self._fc_weight_variable(shape=[512, 256], name="fc3_organ_weight")
                fc3_organ_bias = self._bias_variable(shape=[256], name="fc3_organ_bias")
                fc3_organ_result = tf.nn.relu((tf.matmul(fc2_organ_result, fc3_organ_weight) + fc3_organ_bias),
                                              name="fc3_organ_1_result_%d" % index)
                
                fc4_organ_weight = self._fc_weight_variable(shape=[256, 128], name="fc4_organ_weight")
                ...
                fc5_organ_weight = self._fc_weight_variable(shape=[128, 64], name="fc5_organ_weight")
                fc5_organ_bias = self._bias_variable(shape=[64], name="fc5_organ_bias")
                fc5_organ_result = tf.nn.relu((tf.matmul(fc4_organ_result, fc5_organ_weight) + fc5_organ_bias),
                                              name="fc5_organ_1_result_%d" % index)
                
                fc6_organ_weight = self._fc_weight_variable(shape=[64, 64], name="fc6_organ_weight")
                fc6_organ_bias = self._bias_variable(shape=[64], name="fc6_organ_bias")
                fc6_organ_result = tf.nn.relu((tf.matmul(fc5_organ_result, fc6_organ_weight) + fc6_organ_bias),
                                              name="fc6_organ_1_result_%d" % index)

                fc7_organ_weight = self._fc_weight_variable(shape=[64, 32], name="fc7_organ_1_weight")
                fc7_organ_bias = self._bias_variable(shape=[32], name="fc7_organ_1_bias")
                fc7_organ_result = tf.add(tf.matmul(fc6_organ_result, fc7_organ_weight), fc7_organ_bias,
                                          name="fc7_organ_1_result_%d" % index)

                organ_1_result_list.append(fc7_organ_result)
            ...
            for index in range(len(organ_3_4)):
                ...
                fc4_organ_weight = self._fc_weight_variable(shape=[256, 128], name="fc4_organ_weight")
                fc4_organ_bias = self._bias_variable(shape=[64], name="fc4_organ_bias")
                fc4_organ_result = tf.nn.relu((tf.matmul(fc3_organ_result, fc4_organ_weight) + fc4_organ_bias),
                ...
                fc7_organ_weight = self._fc_weight_variable(shape=[64, 32], name="fc7_organ_2_weight")
                fc7_organ_bias = self._bias_variable(shape=[32], name="fc7_organ_2_bias")
                fc7_organ_result = tf.add(tf.matmul(fc6_organ_result, fc7_organ_weight), fc7_organ_bias,
                                          name="fc7_organ_2_result_%d" % index)

                organ_2_result_list.append(fc7_organ_result)
